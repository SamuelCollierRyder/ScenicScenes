...
def main():
    ...
    try:
        ...
        print(client.show_recorder_file_info("C:/Users/0d87jc/Code/ScenicScenes/logs/recording01.log",False))
        """
        ...
        # This time, a color converter is applied to the image, to get the semantic segmentation view
        sem_cam.listen(lambda image: image.save_to_disk('./images/%.6d.jpg' % image.frame,carla.ColorConverter.CityScapesPalette))
        """
